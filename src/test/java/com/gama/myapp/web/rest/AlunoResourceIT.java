package com.gama.myapp.web.rest;

import static com.gama.myapp.domain.AlunoAsserts.*;
import static com.gama.myapp.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.gama.myapp.IntegrationTest;
...
class AlunoResourceIT {
    ...
    private static final String DEFAULT_CURSO_PRETENDIDO = "AAAAAAAAAA";
    private static final String UPDATED_CURSO_PRETENDIDO = "BBBBBBBBBB";
    ...
    public static Aluno createEntity() {
        return new Aluno().nome(DEFAULT_NOME).sobreNome(DEFAULT_SOBRE_NOME).email(DEFAULT_EMAIL).cursoPretendido(DEFAULT_CURSO_PRETENDIDO);
    }
    ...
    public static Aluno createUpdatedEntity() {
        return new Aluno().nome(UPDATED_NOME).sobreNome(UPDATED_SOBRE_NOME).email(UPDATED_EMAIL).cursoPretendido(UPDATED_CURSO_PRETENDIDO);
    }
    ...
    void getAllAlunos() throws Exception {
        ...
        restAlunoMockMvc
            ...
            .andExpect(jsonPath("$.[*].cursoPretendido").value(hasItem(DEFAULT_CURSO_PRETENDIDO)));
    }
    ...
    void getAluno() throws Exception {
        ...
        restAlunoMockMvc
            ...
            .andExpect(jsonPath("$.cursoPretendido").value(DEFAULT_CURSO_PRETENDIDO));
    }
    ...
    void putExistingAluno() throws Exception {
        ...
        updatedAluno.nome(UPDATED_NOME).sobreNome(UPDATED_SOBRE_NOME).email(UPDATED_EMAIL).cursoPretendido(UPDATED_CURSO_PRETENDIDO);
    ...
    void fullUpdateAlunoWithPatch() throws Exception {
        ...
        partialUpdatedAluno.nome(UPDATED_NOME).sobreNome(UPDATED_SOBRE_NOME).email(UPDATED_EMAIL).cursoPretendido(UPDATED_CURSO_PRETENDIDO);
