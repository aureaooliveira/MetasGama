...
class MetaResourceIT {
    ...
    private static final AreaDoEnem UPDATED_AREA = AreaDoEnem.CNATUREZA;
    ...
    public static Meta createEntity() {
        return new Meta().area(DEFAULT_AREA).nota(DEFAULT_NOTA);
    }
    ...
    public static Meta createUpdatedEntity() {
        return new Meta().area(UPDATED_AREA).nota(UPDATED_NOTA);
    }
